                ...
                <form action="insertdashboard.php" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="hometeam" class="form-control" placeholder="Heimmannschaft" required>
                        </div>
                        <div class="form-group">
                            <label>Gastmannschaft</label>
                            <input type="text" name="awayteam" class="form-control" placeholder="Gastmannschaft" required>
                        </div>
                        <div class="form-group">
                            <label>Heimtore</label>
                            <input type="number" name="homegoals" class="form-control" placeholder="Heimtore" required>
                        </div>
                        <div class="form-group">
                            <label>Gasttore</label>
                            <input type="number" name="awaygoals" class="form-control" placeholder="Gasttore" required>
                        </div>
                        <div class="form-group">
                            <label>Notizen</label>
                            <textarea type="text" name="notes" class="form-control" placeholder="Notizen" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="hometeam" id="hometeam" class="form-control"
                                placeholder="Heimmannschaft" required>
                        </div>
                        <div class="form-group">
                            <label>Gastmannschaft</label>
                            <input type="text" name="awayteam" id="awayteam" class="form-control"
                                placeholder="Gastmannschaft" required>
                        </div>
                        <div class="form-group">
                            <label>Heimtore</label>
                            <input type="text" name="homegoals" id="homegoals" class="form-control"
                                placeholder="Heimtore" required>
                        </div>
                        <div class="form-group">
                            <label>Gasttore</label>
                            <input type="text" name="awaygoals" id="awaygoals" class="form-control"
                                placeholder="Gasttore" required>
                        </div>
                        <div class="form-group">
                            <label>Notizen</label>
                            <textarea rows="6" type="text" name="notes" id="notes" class="form-control"
                                placeholder="Notizen" required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Schliessen</button>
            ...
            ?>
                        <tbody>
                            <tr>
                                ...
                                <td> <?php echo htmlspecialchars($row['notizen'], ENT_QUOTES, "UTF-8"); ?> </td>
                                <td>
                                    <button type="button" class="btn btn-info viewbtn">Anschauen</button>
                                </td>
                                <td>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#hometeam').val(data[1]);
                $('#awayteam').val(data[2]);
                $('#homegoals').val(data[3]);
                $('#awaygoals').val(data[4]);
                $('#notes').val(data[5]);
            });
        });
    </script>
